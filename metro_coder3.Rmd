...
1) Copy and paste all content below the dependency table into empty Rmarkdown document (set to html output)
...
4) Ensure the working directory and paths are set properly. Here are the dependencies and paths for Brookings and non-Brookings machines: (Note - The code assumes you are using a Brookings machine. If not, paths MUST be changed!)
